				...
				<div class="uc-nav-box">
					...
					<div class="box-bd">
						<ul class="uc-nav-list">
							...
							<li>
							<li >
							<a href="{{ url('user/order')}}/?u={{auth::user()->id}}">我的订单</a></li>
				...
				<div class="uc-nav-box">
					...
					<div class="box-bd">
						<ul class="uc-nav-list">
							...
							<li onclick="getWatchlist()"><a href="#">{{trans('portfolio.follow_portfolio')}}</a></li>
						</ul>
					</div>
				</div>
				<div class="uc-nav-box">
