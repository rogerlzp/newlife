...
$params['access_token'] = "396c0873e08edaa36b5a99635b2a2674"; 
$params['refresh_token'] = "";
$params['username'] = "rogerlzp@gmail.com"; //Youku username or email
$params['password'] = md5("AAbb3344"); //Youku password

set_time_limit(0);
ini_set('memory_limit', '128M');
$youkuUploader = new YoukuUploader($client_id, $client_secret);
$file_name = "/mnt/share_folder/1/Wildlife.wmv"; //video file
try {
...
$uploadInfo = array(
		"title" => "heloo", //video title
		"tags" => "hello", //tags, split by space
